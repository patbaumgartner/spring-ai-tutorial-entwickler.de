...
public class OpenAiAudioSpeechModelSpringAiApplication {

	public static void main(String[] args) {
		SpringApplication.run(OpenAiAudioSpeechModelSpringAiApplication.class, args);
	}

	@RestController
	@RequiredArgsConstructor
	static class OpenAiAudioSpeechController {
		...
		byte[] speechProviderOptions(@Value("classpath:speech.txt") Resource resource) {
			var speechResponse = speechModel
				.call(new SpeechPrompt(resource.getContentAsString(Charset.defaultCharset()),
