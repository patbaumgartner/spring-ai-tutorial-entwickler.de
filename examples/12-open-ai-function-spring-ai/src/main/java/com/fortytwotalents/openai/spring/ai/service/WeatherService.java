package com.fortytwotalents.openai.spring.ai.service;
...
public class WeatherService implements Function<WeatherService.Request, WeatherService.Response> {
	...
	public record Request(@JsonProperty(required = true,
			...
			@JsonProperty(required = true,
					value = "unit") @JsonPropertyDescription("Local unit to measure air temperature like F for Fahrenheit countries with the imperial system and C for degree Celsius in countries with metric system.") Unit unit) {
	}
