package com.fortytwotalents.docker.spring.ai;
...
public class DockerModelRunnerSpringAiApplication {

	@Generated
	private static final Logger log = LoggerFactory.getLogger(DockerModelRunnerSpringAiApplication.class);

	public static void main(String[] args) {
		SpringApplication.run(DockerModelRunnerSpringAiApplication.class, args);
	}
