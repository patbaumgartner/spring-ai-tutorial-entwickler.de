...
public class OpenAiRagSpringAiChatClientApplication {

	@Value("Artificial intelligence - Wikipedia.pdf")
	private Resource pdf;

	public static void main(String[] args) {
		SpringApplication.run(OpenAiRagSpringAiChatClientApplication.class, args);
	}
	...
	// @Bean
	CommandLineRunner commandLineRunner2(ChatClient.Builder chatClientBuilder, VectorStore vectorStore) {
		ChatClient chatClient = chatClientBuilder.build();
