...
public class OpenAiImageModelSpringAiApplication {

	public static void main(String[] args) {
		SpringApplication.run(OpenAiImageModelSpringAiApplication.class, args);
	}

	@Slf4j
	@Controller
	@RequiredArgsConstructor
	static class OpenAiImageController {
