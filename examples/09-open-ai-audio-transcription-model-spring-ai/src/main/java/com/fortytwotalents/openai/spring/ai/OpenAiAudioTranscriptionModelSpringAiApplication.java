...
public class OpenAiAudioTranscriptionModelSpringAiApplication {

	public static void main(String[] args) {
		SpringApplication.run(OpenAiAudioTranscriptionModelSpringAiApplication.class, args);
	}

	@RestController
	@RequiredArgsConstructor
	static class OpenAiAudioTranscriptionController {
